...
![Checking DHCP](screenshots/19-dhcp-on.png)
...
![Checking DNS and Subnet mask first](screenshots/24-checking-dns-and-subnet-mask.png)
...
![Setting range, type in given Subnet mask](screenshots/25-destinate-dhcp-scope.png)

To allow the scope clients to use the correct DNS configuration, I entered the server name and the DNS server IP address. 
![Pairing Scope-Clients to DNS](screenshots/26-pairing-scope-clients-to-dns.png)

With these settings completed, the DHCP scope configuration was finalized.
![New Scope completed](screenshots/27-new-scope-completed.png)
