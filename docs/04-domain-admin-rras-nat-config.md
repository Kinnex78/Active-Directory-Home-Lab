...
![Creating Domain Admin](screenshots/13-create-domain-admin.png)
...
![Giving Admin-privilege](screenshots/14-giving-admin-privilege.png)
...
![Checking box RAS](screenshots/15-choosing-ras.png)

Under Role Services, I selected Routing, which automatically also enabled DirectAccess and VPN (RAS).
![Checking box Routing](screenshots/16-choosing-routing.png)
...
![Choose NAT](screenshots/17-choosing-nat.png)

and configured the EXTERNAL interface as the public interface using “Use this public interface."
![Choose public interface: EXTERNAL](screenshots/18-choosing-public-interface-external.png)
